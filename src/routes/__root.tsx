...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ensure Home Loans (NMLS #1666674). Conventional, Non-QM, Jumbo, DSCR, Bank Statement, Hard Money, Construction, Commercial. Licensed in multiple states." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Ensure Home Loans — Your one stop shop for home loans" },
      { name: "twitter:description", content: "Ensure Home Loans (NMLS #1666674). Conventional, Non-QM, Jumbo, DSCR, Bank Statement, Hard Money, Construction, Commercial. Licensed in multiple states." },
