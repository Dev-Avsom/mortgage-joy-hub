...
import { Phone, MessageCircle, Mail, ArrowLeft, ArrowRight, Linkedin, Facebook, Instagram, Twitter, Globe, Youtube } from "lucide-react";
    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_1.4fr]">
        ...
        <div>
          ...
          {(officer.linkedin_url || officer.facebook_url || officer.instagram_url || officer.twitter_url || officer.youtube_url || officer.website_url) && (
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {officer.youtube_url && (
                <a href={officer.youtube_url} target="_blank" rel="noopener noreferrer" aria-label="YouTube"
